...
GUNICORN_CONF_PATH = os.path.join(get_root_path() or "", "gunicorn_conf.py")

APP_PATH = os.path.join(os.path.expanduser("~"), "Program", "restful_server")
...
if TYPE_CHECKING:  # pragma: no cover
    from .backend import (
        start_restful_server,  # noqa: F401
        stop_restful_server,  # noqa: F401
    )
